...
Optimized manifest format generated by the separate `private content repo` repo.
...
This app is designed to work with a separate content/generator repo such as `private content repo`, which publishes:
- `dns.txt`
- `rewrite-rules.json`
